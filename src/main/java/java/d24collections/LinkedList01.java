...
public class LinkedList01 {
    public static void main(String[] args) {
        ...
        //List<String> list3 = new List(); //HATA, constructor tarafina interface yazilamaz
        ...
        //parametre olara girildigi icin liste esnektir.

/*        List<String> immutableList = List.of("Eleman1", "Eleman2", "Eleman3"); //Bu liste degistirilemez
        ...
        //-----------ek bilgi. Tum Yusuf'lari silmek istesek;
