package java.d16methodcreation_overloading_varargs_passbyvalue;

import d16methodcreation_overloading_varargs_passbyvalue.Car;

public class CarRunner {
    public static void main(String[] args) {

        //4- Car class'indan bir object uretelim
        d16methodcreation_overloading_varargs_passbyvalue.Car c1 = new Car();
