...
public class Student {
    ...
    ***Bazi insanlar bilgiyi sadece
    ...
    //Hayır, encapsulation'da private ile gizlenen bir veri başka bir package'dan set method ile değiştirilemez. Private erişim belirleyicisi sadece aynı sınıf içinde erişime izin verir. Eğer veriye başka bir package'dan erişmek ve değiştirmek istiyorsan, set metodu public veya protected olarak tanımlanmalıdır.
}